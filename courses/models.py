...
class Categoria(models.Model):
    ...
    activa = models.BooleanField(default=True, verbose_name="Esta seccion esta visible")
...
class Curso(models.Model):
    ...
    link = models.URLField(max_length=300, verbose_name='link del curso en hotmart')
    precio = models.DecimalField(max_digits=6,
                              decimal_places=2)
    
    activo = models.BooleanField(default=True)
    promocion = models.CharField(max_length=100, null=True, blank=True, verbose_name='si se puede pagar en cuotas. cuantas y a como son las cuotas? ')
